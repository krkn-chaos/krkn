...
- **scenarios/node_scenarios/**
  ...
  - **test_node_reboot_targets_node_name_and_recovers**: Happy path — `node_reboot_scenario` targeted by `node_name` reboots the worker; Kraken exits 0 and the node returns Ready.
