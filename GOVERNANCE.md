...
The Krkn project is dedicated to creating [TODO:Goals of project].  
...
The Krkn and its leadership embrace the following values:
...
Krkn Maintainers have write access to the [project GitHub repository](https://github.com/krkn-chaos/krkn).
...
are people who care about the Krkn project and want to help it grow and
