...
# Thread-safety note: This session is only used from the main thread
# (scenario plugins call get_status/publish_kraken_status synchronously).
# If future callers introduce concurrent access, consider per-thread sessions.
...
def close_http_session():
    ...
    Note: atexit.register(http_session.close) handles normal process exit.
