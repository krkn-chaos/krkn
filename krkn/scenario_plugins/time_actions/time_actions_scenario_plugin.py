    ...
    def exec_with_shell_fallback(
        ...
        for i in range(5):
            ...
            if not response:
                ...
                # Shell fallback failed - even with explicit shell, still can't execute
                logging.error(
    ...
    def pod_exec(
        ...
        for i in range(5):
            ...
            if not response:
                ...
                # Trigger shell fallback mechanism
                logging.warning(
