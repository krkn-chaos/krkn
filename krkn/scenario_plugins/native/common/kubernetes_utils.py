"""
Shared Kubernetes utility functions for native scenario plugins.

This module contains common functions used by both network and pod_network_outage
scenario plugins to avoid code duplication.
"""
