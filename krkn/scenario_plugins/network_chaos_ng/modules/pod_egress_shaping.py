...
from krkn.scenario_plugins.network_chaos_ng.modules.utils_network_shaping import get_bridge_name, get_test_pods, \
    check_bridge_interface, apply_net_policy, wait_for_job, delete_jobs


class PodEgressShapingModule(AbstractNetworkChaosModule):
            ...
            try:
                ...
                for mod in mod_lst:
                    ...
                    if self.config.network_shaping_execution == "serial":
                        ...
                        wait_for_job(job_list[:], self.kubecli.get_lib_kubernetes(),
