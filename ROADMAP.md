...
- [ ] [Add clickable tags/labels for scenario categorization on documentation website](https://github.com/krkn-chaos/website/issues/663)
- [ ] [Add predefined test cases and static recommendations to resiliency scoring framework](https://github.com/krkn-chaos/krkn/issues/1602)
- [x] Krkn Operator Stable Release & OperatorHub Listing — [krkn-operator PR #107](https://github.com/krkn-chaos/krkn-operator/pull/107), [krkn-operator PR #109](https://github.com/krkn-chaos/krkn-operator/pull/109)
- [x] Compliance-Ready Audit Reports (HTML/PDF) — [PR #1555](https://github.com/krkn-chaos/krkn/pull/1555), [krkn-operator PR #113](https://github.com/krkn-chaos/krkn-operator/pull/113), [krkn-operator-console PR #120](https://github.com/krkn-chaos/krkn-operator-console/pull/120)
- [x] Storage Chaos Scenario (I/O Throttle for PVC-backed workloads) — [PR #1296](https://github.com/krkn-chaos/krkn/pull/1296)
- [x] Krkn AI Dashboard Integration — [krkn-operator PR #96](https://github.com/krkn-chaos/krkn-operator/pull/96)
