...
def run(scenarios_list, config, wait_duration):
    ...
    for net_config in scenarios_list:
        ...
        try:
            ...
            logging.error("Cannot find a yaml file at %s, please check" % (net_config))
            sys.exit(1)
