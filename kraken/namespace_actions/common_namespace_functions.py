...
def run(scenarios_list, config, wait_duration, failed_post_scenarios, kubeconfig_path):
    for scenario_config in scenarios_list:
        ...
        try:
            ...
            logging.error("Cannot find a yaml file at %s, please check" % (scenario_config[0]))
            sys.exit(1)
