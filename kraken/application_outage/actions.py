    ...
    for app_outage_config in scenarios_list:
        if len(app_outage_config) > 1:
            ...
            try:
                ...
                logging.error("Cannot find a yaml file at %s, please check" % (app_outage_config))
                sys.exit(1)
